...
var routes = [
  ...
  {
    path: "local",
    loadComponent: () => import("./chunk-24R27QYJ.js").then((m) => m.GrafanaLocalPageComponent),
    title: "proyectIOT \xB7 Grafana Local"
  },
  {
    path: "cloud",
    loadComponent: () => import("./chunk-3Y4RIYW7.js").then((m) => m.GrafanaCloudPageComponent),
    title: "proyectIOT \xB7 Grafana Cloud"
  },
...
var NavbarComponent = class _NavbarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], decls: 16, vars: 0, consts: [[1, "navbar"], [1, "navbar__brand"], [1, "navbar__logo"], [1, "navbar__nav"], ["routerLink", "/local", "routerLinkActive", "activo"], ["routerLink", "/cloud", "routerLinkActive", "activo"]], template: function NavbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, "Panel de control IoT con Grafana");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(9, "ul", 3)(10, "li")(11, "a", 4);
      \u0275\u0275text(12, "Grafana Local");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(13, "li")(14, "a", 5);
      \u0275\u0275text(15, "Grafana Cloud");
      \u0275\u0275elementEnd()()()();
    }
  }, dependencies: [CommonModule, RouterLink, RouterLinkActive], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  position: sticky;\n  top: 0;\n  z-index: 10;\n}\n.navbar[_ngcontent-%COMP%] {\n  background: var(--surface);\n  border-bottom: 1px solid var(--border);\n  padding: 0.75rem 1.5rem;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\n.navbar__brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.65rem;\n  color: var(--text);\n}\n.navbar__brand[_ngcontent-%COMP%]   small[_ngcontent-%COMP%] {\n  display: block;\n  color: var(--text-muted);\n  font-size: 0.72rem;\n}\n.navbar__logo[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #6366f1,\n      #ec4899);\n  width: 36px;\n  height: 36px;\n  border-radius: 10px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.1rem;\n}\n.navbar__nav[_ngcontent-%COMP%] {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  gap: 0.4rem;\n}\n.navbar__nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: var(--text-muted);\n  text-decoration: none;\n  font-weight: 600;\n  font-size: 0.9rem;\n  padding: 0.5rem 0.85rem;\n  border-radius: 8px;\n  border: 1px solid transparent;\n  transition: background 0.15s ease, color 0.15s ease;\n}\n.navbar__nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  color: var(--text);\n  background: var(--surface-2);\n}\n.navbar__nav[_ngcontent-%COMP%]   a.activo[_ngcontent-%COMP%] {\n  color: var(--text);\n  background: var(--surface-2);\n  border-color: var(--border);\n}\n/*# sourceMappingURL=navbar.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NavbarComponent, [{
    type: Component,
    args: [{ selector: "app-navbar", standalone: true, imports: [CommonModule, RouterLink, RouterLinkActive], changeDetection: ChangeDetectionStrategy.OnPush, template: '<nav class="navbar">\r\n  <div class="navbar__brand">\r\n    <span class="navbar__logo">?</span>\r\n    <div>\r\n      <strong>proyectIOT</strong>\r\n      <small>Panel de control IoT con Grafana</small>\r\n    </div>\r\n  </div>\r\n  <ul class="navbar__nav">\r\n    <li>\r\n      <a routerLink="/local" routerLinkActive="activo">Grafana Local</a>\r\n    </li>\r\n    <li>\r\n      <a routerLink="/cloud" routerLinkActive="activo">Grafana Cloud</a>\r\n    </li>\r\n  </ul>\r\n</nav>\r\n', styles: ["/* src/app/components/navbar/navbar.component.scss */\n:host {\n  display: block;\n  position: sticky;\n  top: 0;\n  z-index: 10;\n}\n.navbar {\n  background: var(--surface);\n  border-bottom: 1px solid var(--border);\n  padding: 0.75rem 1.5rem;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\n.navbar__brand {\n  display: flex;\n  align-items: center;\n  gap: 0.65rem;\n  color: var(--text);\n}\n.navbar__brand small {\n  display: block;\n  color: var(--text-muted);\n  font-size: 0.72rem;\n}\n.navbar__logo {\n  background:\n    linear-gradient(\n      135deg,\n      #6366f1,\n      #ec4899);\n  width: 36px;\n  height: 36px;\n  border-radius: 10px;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.1rem;\n}\n.navbar__nav {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  gap: 0.4rem;\n}\n.navbar__nav a {\n  color: var(--text-muted);\n  text-decoration: none;\n  font-weight: 600;\n  font-size: 0.9rem;\n  padding: 0.5rem 0.85rem;\n  border-radius: 8px;\n  border: 1px solid transparent;\n  transition: background 0.15s ease, color 0.15s ease;\n}\n.navbar__nav a:hover {\n  color: var(--text);\n  background: var(--surface-2);\n}\n.navbar__nav a.activo {\n  color: var(--text);\n  background: var(--surface-2);\n  border-color: var(--border);\n}\n/*# sourceMappingURL=navbar.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "src/app/components/navbar/navbar.component.ts", lineNumber: 13 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "contenedor"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, NavbarComponent], template: '<app-navbar></app-navbar>\r\n<main class="contenedor">\r\n  <router-outlet></router-outlet>\r\n</main>\r\n', styles: ["/* src/app/app.component.scss */\n.contenedor {\n  max-width: 1400px;\n  margin: 0 auto;\n  padding: 1.5rem;\n}\n/*# sourceMappingURL=app.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
